...
export const tips = [{
        ...
        explanation: "Writing, like many other hobbies and skills such as math, can come across as intimidating with a great learning curve. We would be lying if we pretended that becoming truly good at writing didn't require a lot of hard work and persistence! But so do most rewarding activities in life! You don't need to be a master of the craft to enjoy the journey. Don't be afraid to dive on in, get messy, get your hands dirty, and let your mind run free. So long as you're willing to be self-critical and always try to improve, it's the only way to get better and better in the first place."
    },{
        index: 2,
        title: "It's not a competition!",
        explanation: "One of the best ways to get better, and one of the most rewarding aspects of writing, is to have others read your work. Someone who doesn't already know your work like you do can, be more detached and independent in their reading. Additonally, a big part of any art is to share it with others, so that your expressions may be communicated to those who may share in the way you see and feel the world. In general, writing communities are very open and supportive. We're friends, not competitors."
    },{
        index: 3,
        title: "Develop discipline!",
        explanation: "There's no one size fits all approach, but for some ideas: Try to devote a half-hour to an hour each day to writing. In particular, make yourself write, even if you don't care for the results; tapping into your stream of conciousness can be equally rewarding. Treat your mind like a pipe of creativity, and work to keep it flowing. The more time you take off, the potentially more mental gunk and cobwebs may clog up the system. One famous writer even suggested not caring about what you write down at all. The important thing is that being a good writer and continuing to improve does take practice."
    },{
        index: 4,
        title: "Don't forget to have fun!",
        explanation: "This is a hobby, not a job. Even if it were a job, you likely got started to have fun. Don't lose sight of that. Don't get so far down in the weeds that you get overwhelmed and miserable. Take breaks. Do what's exciting to you. Don't be afraid to start up a random new side project just to feel happy and motivated again. Maybe you always wanted to write a sci-fi space story, or you were really interested in doing a deep-dive into a particular political or scientific topic but keep putting it off. Whatever it is, always have fun."
    }
];
